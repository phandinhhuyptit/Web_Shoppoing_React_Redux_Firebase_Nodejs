                ...
                <div className=" col-xl-4 col-lg-6 col-md-6 col-sm-6 ">
                    <div className="card mb-4 equal_Cards ">
                        ...
                        <div className="image-hover">
                            <a href="14">
                                <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/Logitech/Mouse/g502-hero/8-400x400.jpg" aria-hidden alt="Card image cap" />
                            </a>
                        </div>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div className="card mb-4 equal_Cards ">
                        <a href="435" className="Image-main">
                            <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/rantopad/mxx/silver/7-400x400.jpg" aria-hidden alt="Card image cap" />
                        </a>
                        <div className="image-hover">
                            <a href="5346">
                                <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/rantopad/mxx/silver/1-400x400.jpg" aria-hidden alt="Card image cap" />
                            </a>
                        </div>
                        <div className="card-body Information_Items">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div className="card mb-4 equal_Cards ">
                        <a href="54" className="Image-main">
                            <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/rantopad/mxx/black-cherry/1-400x400.jpg" aria-hidden alt="Card image cap" />
                        </a>
                        <div className="image-hover">
                            <a href="546">
                                <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/rantopad/mxx/black-cherry/2-400x400.jpg" aria-hidden alt="Card image cap" />
                            </a>
                        </div>
                        <div className="card-body Information_Items">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div className="card mb-4 equal_Cards ">
                        <a href="234" className="Image-main">
                            <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/Leopold/750-swe/1-400x400.jpg" aria-hidden alt="Card image cap" />
                        </a>
                        <div className="image-hover">
                            <a href="467">
                                <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/Leopold/750-swe/7-400x400.jpg" aria-hidden alt="Card image cap" />
                            </a>
                        </div>
                        <div className="card-body Information_Items">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6 col-sm-6">
                    <div className="card mb-4 equal_Cards ">
                        <a href="4123" className="Image-main">
                            <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/Xigmatek/case/astro_a/rgb/1-200x200.jpg" aria-hidden alt="Card image cap" />
                        </a>
                        <div className="image-hover">
                            <a href="799">
                                <img className="card-img-top img-fluid" src="https://www.playzone.vn/image/cache/catalog/san%20pham/Xigmatek/case/astro_a/rgb/2-200x200.jpg" aria-hidden alt="Card image cap" />
                            </a>
                        </div>
                        <div className="card-body Information_Items">
