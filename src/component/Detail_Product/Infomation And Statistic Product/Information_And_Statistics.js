    ...
    render() {
        return (
                ...
                <div className="container">
                    <div className="row">
                        <ul className="List_Menu">
                            <li data_description="Description">
                                <button type="button" className="btn btn-outline-primary Detription Active_Destription_Or_Review">Mô Tả</button>
                            </li>
                            <li data_description="Review">
                                <button type="button" className="btn btn-outline-primary Review">Đánh Giá</button>
                            </li>
                        </ul>
                        <div className="Content_Destription_Review">
                            <div className="Sub_Content_Destription">
                                ...
                                <div className="Wrap_Video">
                                    ...
                                    <div className="Content_Video">
                                        ...
                                        <p className="Button_Watch_Video">
                                            WATCH VIDEO
              </p>
                                    </div>
                                </div>
            ...
            đều đem lại cho bạn sự thoải mái cao độ khi sử dụng trong thời gian dài.</p>
                            ...
                            <div className="Sub_Content_Review">
...
export default InformationAndStatistics;